...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        return view('dashboard', compact('statistik', 'totalMahasiswa', 'totalDosen', 'totalJadwal','totalFeedback',
    ...
    public function generateLaporan(Request $request)
    {
        ...
        return view('dashboard', compact('aktivitasMahasiswa', 'aktivitasDosen'));
    }
}
