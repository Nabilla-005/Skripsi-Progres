        ...
        <div class="col-lg-8 content">
          @foreach($mahasiswa as $mahasiswas)
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>NIM:</strong> <span>{{ $mahasiswas->nim }}</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span>{{ $mahasiswas->email }}</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Fakultas:</strong> <span>{{ $mahasiswas->program_studi }}</span></li>
                </ul>
              </div>
            </div>
          @endforeach
